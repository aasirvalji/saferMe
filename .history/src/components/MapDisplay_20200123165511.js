...
function Map() {
  ...
  //null because nothing selected initially
    ...
    <GoogleMap defaultZoom = {5} defaultCenter = {{lat: 42.997570, lng: -81.276710}} defaultOptions={{styles: mapStyles}}>
...
<div className = 'map-div' style={{ width: "100vw", height: "50vh", margin: "auto", marginBottom: "10vh" }}>
<MapWrapped

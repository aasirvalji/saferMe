...
export class Map extends React.Component {
  ...
  render(){
    ...
    {this.state.selectedPark && ( //is selectedPark is true, return whatever is after &&
      <InfoWindow        
      position={{
            lat: this.state.selectedPark.lat,
            lng: this.state.selectedPark.lng
          }}
          onCloseClick={() => {
          ...
          <h2>{this.state.selectedPark.lat}</h2>
          <p>{this.state.selectedPark.lng}</p>
          <p>Safety score: 69</p>
          <img src = {yeet}></img>

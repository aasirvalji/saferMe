  ...
  render(){
    ...
    {this.state.selectedPark && ( //is selectedPark is true, return whatever is after &&
      ...
      position={{
          ...
          (<img src = {'https://cdn.pixabay.com/photo/2017/07/27/12/12/stop-2545121_960_720.png'} style={{width: '10vh', height: '10vh'}}>
...
function sendData(){
    ...
    xhr.open('POST', 'alishan.pythonanywhere.com/alert')
    // send the request

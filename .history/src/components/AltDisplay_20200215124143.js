...
<form class="contact-section" onSubmit={this.handleSubmit}>
      <div class="inner-width">
       ...
       username={this.state.username} onChange={this.handleChange} ></input>
        ...
        <textarea rows="1" placeholder="Your emergency contact name" name = 'emergencyName' 
        class="message"></textarea>

        <textarea rows="1" placeholder="Your emergency contact phone number" name = 'emergencyNumber' 
        class="message"></textarea>
